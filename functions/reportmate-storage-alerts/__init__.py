...
def main(mytimer: func.TimerRequest) -> None:
    ...
    # If you want to use Managed Identity, ensure the Function App has the identity assigned
    # and the target API accepts AAD tokens.
    # credential = DefaultAzureCredential()
    # token = credential.get_token("api://<target-app-client-id>/.default")
    ...
    if api_key:
        ...
        # Also adding X-API-PASSPHRASE as it is commonly used in this project
        ...
        for device in devices:
            ...
            if not hardware:
                try:
                    ...
                    # logging.info(f"Fetching details for {serial_number}") 
